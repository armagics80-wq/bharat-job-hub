...
export const MONITORED_WEBSITES: MonitoredWebsite[] = [
  ...
  // UPSC (Union Public Service Commission) - MAIN
  { id: 'c-upsc-main', name: 'UPSC (Union Public Service Commission) - MAIN', url: 'https://upsc.gov.in/', category: 'Central', department: 'Union Public Service Commission' },
  { id: 'c-upsc-online', name: 'UPSC Online Application', url: 'https://upsconline.nic.in/', category: 'Central', department: 'Union Public Service Commission' },
  { id: 'c-upsc-results-main', name: 'UPSC Results', url: 'https://upsc.gov.in/results', category: 'Central', department: 'Union Public Service Commission' },
  { id: 'c-upsc-calendar', name: 'UPSC Exam Calendar', url: 'https://upsc.gov.in/event/exam-calendar', category: 'Central', department: 'Union Public Service Commission' },
  { id: 'c-upsc-vacancies-2026', name: 'UPSC Vacancies', url: 'https://upsc.gov.in/writereaddata/Notification/1_Vacancy_2026.pdf', category: 'Central', department: 'Union Public Service Commission' },

  // SSC (Staff Selection Commission)
  { id: 'c-ssc-main', name: 'Staff Selection Commission (SSC)', url: 'https://ssc.nic.in/', category: 'Central', department: 'Recruitment Board' },
  { id: 'c-ssc-online', name: 'SSC Online Registration', url: 'https://ssconline.nic.in/', category: 'Central', department: 'Recruitment Board' },
  { id: 'c-ssc-results', name: 'SSC Results', url: 'https://ssc.nic.in/results', category: 'Central', department: 'Recruitment Board' },
  { id: 'c-ssc-calendar-alerts', name: 'SSC Exam Calendar', url: 'https://ssc.nic.in/Alerts1', category: 'Central', department: 'Recruitment Board' },

  // RAILWAY RECRUITMENT
  { id: 'c-rrb-cdg-main', name: 'RRB (Railway Recruitment Board)', url: 'https://www.rrbcd.gov.in/', category: 'Central', department: 'Railway Recruitment' },
  { id: 'c-rrb-online-html', name: 'RRB Online', url: 'https://www.rrbcd.gov.in/online.html', category: 'Central', department: 'Railway Recruitment' },
  { id: 'c-railways-careers', name: 'Indian Railways Careers', url: 'https://www.indianrailways.gov.in/', category: 'Central', department: 'Railway Recruitment' },
  { id: 'c-rrc-mumbai', name: 'Railway Recruitment Cells', url: 'https://rrcmumbai.gov.in/', category: 'Central', department: 'Railway Recruitment' },
  { id: 'c-rrcb-ntpc', name: 'RRB NTPC', url: 'https://www.rrcb.gov.in/', category: 'Central', department: 'Railway Recruitment' },
  { id: 'c-rrb-chennai', name: 'RRB ALP', url: 'https://www.rrbchennai.gov.in/', category: 'Central', department: 'Railway Recruitment' },
  { id: 'c-rrb-kolkata', name: 'RRB Group D', url: 'https://www.rrbkolkata.gov.in/', category: 'Central', department: 'Railway Recruitment' },
  { id: 'c-railways-recruitment', name: 'All RRBs', url: 'https://www.railways.gov.in/recruitment', category: 'Central', department: 'Railway Recruitment' },

  // BANKING SECTOR
  { id: 'c-ibps-main', name: 'IBPS (Institute of Banking Personnel Selection)', url: 'https://ibps.in/', category: 'Central', department: 'Banking Sector' },
  { id: 'c-ibps-apply', name: 'IBPS Online', url: 'https://ibps.in/apply', category: 'Central', department: 'Banking Sector' },
  { id: 'c-sbi-rec', name: 'SBI Recruitment', url: 'https://sbi.co.in/web/careers', category: 'Central', department: 'Banking Sector' },
  { id: 'c-rbi-rec', name: 'RBI Recruitment', url: 'https://rbi.org.in/scripts/ContactUs.aspx', category: 'Central', department: 'Banking Sector' },
  { id: 'c-nabard-rec', name: 'NABARD Recruitment', url: 'https://nabard.org/', category: 'Central', department: 'Banking Sector' },
  { id: 'c-sidbi-rec', name: 'SIDBI Recruitment', url: 'https://sidbi.in/', category: 'Central', department: 'Banking Sector' },
  { id: 'c-pnb-rec', name: 'PNB Recruitment', url: 'https://pnb.co.in/', category: 'Central', department: 'Banking Sector' },
  { id: 'c-bob-rec', name: 'Bank of Baroda', url: 'https://bankofbaroda.in/', category: 'Central', department: 'Banking Sector' },
  { id: 'c-canara-rec', name: 'Canara Bank', url: 'https://canarabank.in/', category: 'Central', department: 'Banking Sector' },
  { id: 'c-unionbank-rec', name: 'Union Bank', url: 'https://unionbankofindia.in/', category: 'Central', department: 'Banking Sector' },
  { id: 'c-iob-rec', name: 'IOB Recruitment', url: 'https://iob.in/', category: 'Central', department: 'Banking Sector' },

  // DEFENSE SECTOR
  { id: 'c-army-cdac', name: 'Indian Army', url: 'https://joinindianarmy.cdac.in/', category: 'Central', department: 'Defense Sector' },
  { id: 'c-navy-join', name: 'Indian Navy', url: 'https://www.joinindiannavy.gov.in/', category: 'Central', department: 'Defense Sector' },
  { id: 'c-iaf-rec', name: 'Indian Air Force', url: 'https://airmenselection.cdac.in/', category: 'Central', department: 'Defense Sector' },
  { id: 'c-icg-join', name: 'Coast Guard', url: 'https://joinindiancoastguard.gov.in/', category: 'Central', department: 'Defense Sector' },
  { id: 'c-agniveer-army', name: 'Agniveer Army', url: 'https://joinindianarmy.cdac.in/', category: 'Central', department: 'Defense Sector' },
  { id: 'c-agniveer-navy', name: 'Agniveer Navy', url: 'https://www.joinindiannavy.gov.in/', category: 'Central', department: 'Defense Sector' },
  { id: 'c-agniveer-iaf', name: 'Agniveer Air Force', url: 'https://airmenselection.cdac.in/', category: 'Central', department: 'Defense Sector' },
  { id: 'c-navy-ssraa', name: 'SSR AA', url: 'https://airmenselection.cdac.in/', category: 'Central', department: 'Defense Sector' },
  { id: 'c-agniveer-hr', name: 'Agniveer HR', url: 'https://joinindianarmy.cdac.in/', category: 'Central', department: 'Defense Sector' },
  { id: 'c-defence-parakram', name: 'Defence Recruitment', url: 'https://parakram2023.gov.in/', category: 'Central', department: 'Defense Sector' },

  // POLICE & HOME AFFAIRS
  { id: 'c-mha-vacancies', name: 'MHA (Ministry of Home Affairs)', url: 'https://mha.gov.in/notifications/vacancies', category: 'Central', department: 'Police & Home Affairs' },
  { id: 'c-bsf-crpf-vacancy', name: 'BSF Recruitment', url: 'https://bsf.gov.in/CRPFVacancy.html', category: 'Central', department: 'Police & Home Affairs' },
  { id: 'c-cisf-rec', name: 'CISF Recruitment', url: 'https://cisf.gov.in/', category: 'Central', department: 'Police & Home Affairs' },
  { id: 'c-crpf-rec', name: 'CRPF Recruitment', url: 'https://crpf.gov.in/', category: 'Central', department: 'Police & Home Affairs' },
  { id: 'c-itbp-rec', name: 'ITBP Recruitment', url: 'https://itbpolice.nic.in/', category: 'Central', department: 'Police & Home Affairs' },
  { id: 'c-ssb-rec-official', name: 'SSB Recruitment', url: 'https://ssb.nic.in/', category: 'Central', department: 'Police & Home Affairs' },
  { id: 'c-nsg-rec', name: 'NSG Recruitment', url: 'https://nsg.gov.in/', category: 'Central', department: 'Police & Home Affairs' },
  { id: 'c-assam-rifles', name: 'Assam Rifles', url: 'https://assamrifles.gov.in/', category: 'Central', department: 'Police & Home Affairs' },

  // IT & DIGITAL INDIA
  { id: 'c-dic-careers', name: 'Digital India Corporation', url: 'https://dic.gov.in/careers/', category: 'Central', department: 'IT & Digital India' },
  { id: 'c-nic-careers', name: 'NIC Careers', url: 'https://nic.in/', category: 'Central', department: 'IT & Digital India' },
  { id: 'c-cdac-careers', name: 'CDAC Careers', url: 'https://cdac.in/', category: 'Central', department: 'IT & Digital India' },
  { id: 'c-cdac-recruitment', name: 'C-DAC Recruitment', url: 'https://cdac.in/index.aspx?id=careers', category: 'Central', department: 'IT & Digital India' },
  { id: 'c-meity-rec', name: 'MeitY Recruitment', url: 'https://meity.gov.in/', category: 'Central', department: 'IT & Digital India' },
  { id: 'c-uidai-rec', name: 'UIDAI Recruitment', url: 'https://uidai.gov.in/', category: 'Central', department: 'IT & Digital India' },
  { id: 'c-disha-rec', name: 'DISHA Recruitment', url: 'https://disha.gov.in/', category: 'Central', department: 'IT & Digital India' },

  // PSUs (Public Sector Undertakings)
  { id: 'c-psujobs-portal', name: 'PSU Jobs', url: 'https://psujobs.gov.in/', category: 'Central', department: 'PSUs' },
  { id: 'c-bhel-careers', name: 'BHEL Careers', url: 'https://bhel.com/careers', category: 'Central', department: 'PSUs' },
  { id: 'c-ntpc-careers', name: 'NTPC Careers', url: 'https://ntpc.co.in/careers', category: 'Central', department: 'PSUs' },
  { id: 'c-ongc-careers', name: 'ONGC Careers', url: 'https://ongcindia.com/careers', category: 'Central', department: 'PSUs' },
  { id: 'c-iocl-careers-main', name: 'IOCL Careers', url: 'https://iocl.com/careers', category: 'Central', department: 'PSUs' },
  { id: 'c-gail-careers', name: 'GAIL Careers', url: 'https://gail.co.in/careers', category: 'Central', department: 'PSUs' },
  { id: 'c-coalindia-careers', name: 'Coal India', url: 'https://coalindia.in/careers', category: 'Central', department: 'PSUs' },
  { id: 'c-cairnindia', name: 'Cairn India', url: 'https://cairnindia.com/', category: 'Central', department: 'PSUs' },
  { id: 'c-hpcl-careers', name: 'HPCL Careers', url: 'https://hpcl.co.in/careers', category: 'Central', department: 'PSUs' },
  { id: 'c-bpcl-careers', name: 'BPCL Careers', url: 'https://bpcl.co.in/careers', category: 'Central', department: 'PSUs' },
  { id: 'c-psujobs-rec', name: 'PSU Recruitment', url: 'https://psujobs.gov.in/', category: 'Central', department: 'PSUs' },

  // PSUs - ALL COMPANIES
  { id: 'c-powergrid-rec-main', name: 'POWER GRID', url: 'https://powergrid.in/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-pgcil-careers', name: 'PGCIL', url: 'https://pgcil.com/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-ntpc-careers-all', name: 'NTPC', url: 'https://ntpc.co.in/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-nhpc-careers', name: 'NHPC', url: 'https://nhpcindia.com/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-thdc-careers', name: 'THDC', url: 'https://thdc.co.in/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-sjvnl-careers', name: 'SJVNL', url: 'https://sjvnl.com/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-nvvn-careers', name: 'NVVN', url: 'https://nvvn.co.in/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-ircon-careers', name: 'IRCON', url: 'https://ircon.in/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-rvnl-careers', name: 'RVNL', url: 'https://rvnl.org/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-pfc-careers', name: 'PFC', url: 'https://pfcindia.com/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-rec-careers', name: 'REC', url: 'https://recindia.nic.in/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-iffco-careers', name: 'IFFCO', url: 'https://iffco.co.in/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },
  { id: 'c-kribhco-careers', name: 'KRIBHCO', url: 'https://kribhco.in/careers', category: 'Central', department: 'PSUs - ALL COMPANIES' },

  // MINISTRIES & DEPARTMENTS
  { id: 'c-min-personnel', name: 'Ministry of Personnel', url: 'https://persmin.gov.in/VUAO/LoginForm.asp', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-defence', name: 'Ministry of Defence', url: 'https://mod.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-mha-dept', name: 'Ministry of Home Affairs', url: 'https://mha.gov.in/notifications/vacancies', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-finance', name: 'Ministry of Finance', url: 'https://finmin.nic.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-education', name: 'Ministry of Education', url: 'https://education.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-health', name: 'Ministry of Health', url: 'https://mohfw.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-railways', name: 'Ministry of Railways', url: 'https://railways.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-civilaviation', name: 'Ministry of Civil Aviation', url: 'https://caab.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-shipping', name: 'Ministry of Shipping', url: 'https://meri.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-roadtransport', name: 'Ministry of Road Transport', url: 'https://morth.nic.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-power', name: 'Ministry of Power', url: 'https://powermin.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-petroleum', name: 'Ministry of Petroleum', url: 'https://petroleum.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-steel', name: 'Ministry of Steel', url: 'https://steelmin.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-mines', name: 'Ministry of Mines', url: 'https://mines.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-heavyindustries', name: 'Ministry of Heavy Industries', url: 'https://heavyindustries.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-chemicals', name: 'Ministry of Chemicals', url: 'https://chemicals.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-textiles', name: 'Ministry of Textiles', url: 'https://textiles.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-agriculture', name: 'Ministry of Agriculture', url: 'https://agricoop.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-environment', name: 'Ministry of Environment', url: 'https://moef.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-waterresources', name: 'Ministry of Water Resources', url: 'https://wrmin.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-ruraldev', name: 'Ministry of Rural Development', url: 'https://mord.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-panchayati-raj', name: 'Ministry of Panchayati Raj', url: 'https://panchayatrraj.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-urbandev', name: 'Ministry of Urban Development', url: 'https://moud.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-wcd', name: 'Ministry of Women & Child', url: 'https://wcd.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-socialjustice', name: 'Ministry of Social Justice', url: 'https://socialjustice.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-tribal', name: 'Ministry of Tribal Affairs', url: 'https://tribal.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-minority', name: 'Ministry of Minority Affairs', url: 'https://minorityaffairs.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-ayush', name: 'Ministry of AYUSH', url: 'https://ayush.gov.in/', category: 'Central', department: 'Ministries & Departments' },
  { id: 'c-min-ayush-rec', name: 'Ministry of AYUSH Recruitment', url: 'https://ayush.gov.in/careers', category: 'Central', department: 'Ministries & Departments' },

  // RADIO & TELECOMMUNICATION
  { id: 'c-radio-doordarshan', name: 'Doordarshan', url: 'https://ddnews.gov.in/', category: 'Central', department: 'Radio & Telecommunication' },
  { id: 'c-radio-air', name: 'All India Radio', url: 'https://allindiaradio.gov.in/', category: 'Central', department: 'Radio & Telecommunication' },
  { id: 'c-radio-prasarbharati', name: 'Prasar Bharati', url: 'https://prasarbharati.gov.in/', category: 'Central', department: 'Radio & Telecommunication' },
  { id: 'c-telecom-rec', name: 'Telecom Recruitment', url: 'https://dot.gov.in/', category: 'Central', department: 'Radio & Telecommunication' },
  { id: 'c-bsnl-careers', name: 'BSNL Careers', url: 'https://bsnl.co.in/careers', category: 'Central', department: 'Radio & Telecommunication' },
  { id: 'c-mtnl-careers', name: 'MTNL Careers', url: 'https://mtnl.net.in/careers', category: 'Central', department: 'Radio & Telecommunication' },
  { id: 'c-tcs-recruitment', name: 'TCS Recruitment', url: 'https://tcs.gov.in/', category: 'Central', department: 'Radio & Telecommunication' },

  // SCIENTIFIC & RESEARCH
  { id: 'c-scientific-isro', name: 'ISRO Careers', url: 'https://isro.gov.in/careers', category: 'Central', department: 'Scientific & Research' },
  { id: 'c-scientific-drdo', name: 'DRDO Careers', url: 'https://drdo.gov.in/careers', category: 'Central', department: 'Scientific & Research' },
  { id: 'c-scientific-barc', name: 'BARC Careers', url: 'https://barc.gov.in/careers', category: 'Central', department: 'Scientific & Research' },
  { id: 'c-scientific-csir', name: 'CSIR Careers', url: 'https://csir.res.in/careers', category: 'Central', department: 'Scientific & Research' },
  { id: 'c-scientific-icmr', name: 'ICMR Careers', url: 'https://icmr.nic.in/', category: 'Central', department: 'Scientific & Research' },
  { id: 'c-scientific-icar', name: 'ICAR Careers', url: 'https://icar.gov.in/', category: 'Central', department: 'Scientific & Research' },
  { id: 'c-scientific-aerb', name: 'AERB Careers', url: 'https://aerb.gov.in/', category: 'Central', department: 'Scientific & Research' },
  { id: 'c-scientific-nrsc', name: 'NRSC Careers', url: 'https://nrsc.gov.in/', category: 'Central', department: 'Scientific & Research' },
  { id: 'c-scientific-iisc', name: 'IISc Careers', url: 'https://iisc.ac.in/', category: 'Central', department: 'Scientific & Research' },
  { id: 'c-scientific-iits', name: 'IITs Careers', url: 'https://iit.ac.in/careers', category: 'Central', department: 'Scientific & Research' },

  // HEALTH & MEDICAL
  { id: 'c-health-aiims', name: 'AIIMS Careers', url: 'https://aiims.edu/careers', category: 'Central', department: 'Health & Medical' },
  { id: 'c-health-jipmer', name: 'JIPMER Careers', url: 'https://jipmer.edu.in/careers', category: 'Central', department: 'Health & Medical' },
  { id: 'c-health-pgimer', name: 'PGIMER Careers', url: 'https://pgimer.edu.in/careers', category: 'Central', department: 'Health & Medical' },
  { id: 'c-health-nimhans', name: 'NIMHANS Careers', url: 'https://nimhans.ac.in/careers', category: 'Central', department: 'Health & Medical' },
  { id: 'c-health-igims', name: 'IGIIMS', url: 'https://igims.org/', category: 'Central', department: 'Health & Medical' },
  { id: 'c-health-ncdc', name: 'NCDC Careers', url: 'https://ncdcindia.org/', category: 'Central', department: 'Health & Medical' },
  { id: 'c-health-icmr-dup', name: 'ICMR', url: 'https://icmr.nic.in/', category: 'Central', department: 'Health & Medical' },
  { id: 'c-health-nin', name: 'NIN Careers', url: 'https://nin.res.in/', category: 'Central', department: 'Health & Medical' },

  // EDUCATION & UNIVERSITIES
  { id: 'c-edu-ugc', name: 'UGC Careers', url: 'https://ugc.ac.in/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-ncert', name: 'NCERT Careers', url: 'https://ncert.nic.in/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-cbse', name: 'CBSE Careers', url: 'https://cbse.gov.in/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-aicte', name: 'AICTE Careers', url: 'https://aicte-india.org/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-icai', name: 'ICAI Careers', url: 'https://icai.org/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-icwa', name: 'ICWA Careers', url: 'https://icmai.in/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-nba', name: 'NBA Careers', url: 'https://nba.org.in/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-naac', name: 'NAAC Careers', url: 'https://naac.gov.in/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-auro-uni', name: 'AURO University', url: 'https://auroUniversity.edu.in/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-jnu', name: 'JNU Careers', url: 'https://jnu.ac.in/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-du', name: 'Delhi University', url: 'https://du.ac.in/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-jmi', name: 'JMI Careers', url: 'https://jmi.ac.in/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-bhu', name: 'BHU Careers', url: 'https://bhu.ac.in/', category: 'Central', department: 'Education & Universities' },
  { id: 'c-edu-amu', name: 'AMU Careers', url: 'https://amu.ac.in/', category: 'Central', department: 'Education & Universities' },

  // TREASURY & ACCOUNTS
  { id: 'c-treasury-cag', name: 'CAG Careers', url: 'https://cag.gov.in/', category: 'Central', department: 'Treasury & Accounts' },
  { id: 'c-treasury-cvc', name: 'CVC Careers', url: 'https://cvc.gov.in/', category: 'Central', department: 'Treasury & Accounts' },
  { id: 'c-treasury-cbi', name: 'CBI Careers', url: 'https://cbi.gov.in/', category: 'Central', department: 'Treasury & Accounts' },
  { id: 'c-treasury-ed', name: 'ED Careers', url: 'https://ed.gov.in/', category: 'Central', department: 'Treasury & Accounts' },
  { id: 'c-treasury-it-dept', name: 'IT Department', url: 'https://incometax.gov.in/', category: 'Central', department: 'Treasury & Accounts' },
  { id: 'c-treasury-customs', name: 'Customs', url: 'https://cbic.gov.in/', category: 'Central', department: 'Treasury & Accounts' },
  { id: 'c-treasury-itax-rec', name: 'Income Tax Recruitment', url: 'https://campoffice.gov.in/', category: 'Central', department: 'Treasury & Accounts' },
  { id: 'c-treasury-nsdl', name: 'NSDL Careers', url: 'https://nsdl.co.in/', category: 'Central', department: 'Treasury & Accounts' },
  { id: 'c-treasury-uti', name: 'UTI Careers', url: 'https://utindia.co.in/', category: 'Central', department: 'Treasury & Accounts' },

  // ELECTORAL & ELECTION
  { id: 'c-electoral-eci', name: 'Election Commission', url: 'https://eci.gov.in/', category: 'Central', department: 'Electoral & Election' },
  { id: 'c-electoral-eci-careers', name: 'ECI Careers', url: 'https://eci.gov.in/careers', category: 'Central', department: 'Electoral & Election' },
  { id: 'c-electoral-delhi', name: 'Delhi Election', url: 'https://elections.delhi.gov.in/', category: 'Central', department: 'Electoral & Election' },

  // STATES & UTs RECRUITMENT (All)
  { id: 'dl-dsssb-rec', name: 'DSSSB (Delhi)', url: 'https://dsssb.delhi.gov.in/', category: 'Delhi', department: 'Recruitment Board' },
  { id: 'up-uppsc-rec-state', name: 'UPPSC (UP)', url: 'https://uppsc.up.nic.in/', category: 'Uttar Pradesh', department: 'Recruitment Board' },
  { id: 'up-uptet-state', name: 'UPTET', url: 'https://uptet.gov.in/', category: 'Uttar Pradesh', department: 'Education Department' },
  { id: 'jh-jpsc-rec-state', name: 'JPSC (Jharkhand)', url: 'https://jpsc.gov.in/', category: 'Jharkhand', department: 'Recruitment Board' },
  { id: 'as-apsc-rec-state', name: 'APSC (Assam)', url: 'https://apsc.in/', category: 'Assam', department: 'Recruitment Board' },
  { id: 'br-bpsc-rec-state', name: 'BPSC (Bihar)', url: 'https://bpsc.bih.nic.in/', category: 'Bihar', department: 'Recruitment Board' },
  { id: 'ka-kpsc-rec-state', name: 'KPSC (Karnataka)', url: 'https://kpsc.kar.nic.in/', category: 'Karnataka', department: 'Recruitment Board' },
  { id: 'gj-gpsc-rec-state', name: 'GPSC (Gujarat)', url: 'https://gpsc.gujarat.gov.in/', category: 'Gujarat', department: 'Recruitment Board' },
  { id: 'mh-mpsc-rec-state', name: 'MPSC (Maharashtra)', url: 'https://mpsc.gov.in/', category: 'Maharashtra', department: 'Recruitment Board' },
  { id: 'kl-kpsc-rec-state', name: 'KPSC (Kerala)', url: 'https://kpsc.kerala.gov.in/', category: 'Kerala', department: 'Recruitment Board' },
  { id: 'tn-tnpsc-rec-state', name: 'TNPSC (Tamil Nadu)', url: 'https://tnpsc.gov.in/', category: 'Tamil Nadu', department: 'Recruitment Board' },
  { id: 'rj-rpsc-rec-state', name: 'RPSC (Rajasthan)', url: 'https://rpsc.rajasthan.gov.in/', category: 'Rajasthan', department: 'Recruitment Board' },
  { id: 'wb-wbpsc-rec-state', name: 'WBPSC (West Bengal)', url: 'https://wbpsc.gov.in/', category: 'West Bengal', department: 'Recruitment Board' },
  { id: 'pb-ppsc-rec-state', name: 'SPSC (Punjab)', url: 'https://ppsc.gov.in/', category: 'Punjab', department: 'Recruitment Board' },
  { id: 'hr-hpsc-rec-state', name: 'HPSC (Haryana)', url: 'https://hppsc.haryana.gov.in/', category: 'Haryana', department: 'Recruitment Board' },
  { id: 'or-opsc-rec-state', name: 'OPSC (Odisha)', url: 'https://opsc.gov.in/', category: 'Odisha', department: 'Recruitment Board' },

  // JOB NOTIFICATION AGGREGATORS
  { id: 'c-aggregator-empnews', name: 'Employment News', url: 'https://employmentnews.gov.in/', category: 'Central', department: 'Job Notification Aggregators' },
  { id: 'c-aggregator-ncs', name: 'National Career Service', url: 'https://www.ncs.gov.in/', category: 'Central', department: 'Job Notification Aggregators' },
  { id: 'c-aggregator-services-india', name: 'Services India Portal', url: 'https://services.india.gov.in/', category: 'Central', department: 'Job Notification Aggregators' },
  { id: 'c-aggregator-freejobalert', name: 'FreeJobAlert', url: 'https://www.freejobalert.com/', category: 'Central', department: 'Job Notification Aggregators' }
];
